    ...
    extends Service
{
     ...
     * 
     * @return
     *     returns BanckAccountService
     */
    @WebEndpoint(name = "BanckAccountServicePort")
    public BanckAccountService getBanckAccountServicePort() {
        return super.getPort(new QName("http://ws/", "BanckAccountServicePort"), BanckAccountService.class);
    }
     ...
     */
    @WebEndpoint(name = "BanckAccountServicePort")
    public BanckAccountService getBanckAccountServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://ws/", "BanckAccountServicePort"), BanckAccountService.class, features);
    }
